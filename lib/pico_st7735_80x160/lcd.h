...
#define SPI_INST_DEFAULT            2   // 0: spi0, 1: spi1
#endif
...
// For waveshare RP2350_PiZero board with Seengreat WM8960+ST7735 TFT 0.96" display
#define SPI_INST_WAVESHARE_A           2   // 0: spi0, 1: spi1
#define PIN_LCD_SPI0_CS_A             17   //  1,  5, 17
#define PIN_LCD_SPI0_SCK_A            18   //  2,  6, 18
#define PIN_LCD_SPI0_MOSI_A           19   //  3,  7, 19

#define PIN_LCD_SPI1_CS_WAVESHARE_A    8   //  9, 13
#define PIN_LCD_SPI1_SCK_WAVESHARE_A  11  // 10, 14
#define PIN_LCD_SPI1_MOSI_WAVESHARE_A 10  // 11, 15
#define PIN_LCD_DC_WAVESHARE_A        24  // any GPIO
